...
void AImpactNumbers_C::init_a_new_number_set(struct FFortDamageNumberInfo* NewDamageHitInfoStruct, struct FTransform* OutCameraTransform, struct FVector* OutNumberLocation)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function ImpactNumbers.ImpactNumbers_C.init a new number set");
...
void AImpactNumbers_C::OnNewDamageNumber(const struct FFortDamageNumberInfo& NewDamageNumberInfo)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function ImpactNumbers.ImpactNumbers_C.OnNewDamageNumber");
...
void AImpactNumbers_C::ExecuteUbergraph_ImpactNumbers(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function ImpactNumbers.ImpactNumbers_C.ExecuteUbergraph_ImpactNumbers");
