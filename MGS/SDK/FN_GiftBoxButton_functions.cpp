...
void UGiftBoxButton_C::Construct()
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GiftBoxButton.GiftBoxButton_C.Construct");
...
void UGiftBoxButton_C::PlayGiftSelectedAnimation(bool bIsSelected)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GiftBoxButton.GiftBoxButton_C.PlayGiftSelectedAnimation");
...
void UGiftBoxButton_C::ExecuteUbergraph_GiftBoxButton(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GiftBoxButton.GiftBoxButton_C.ExecuteUbergraph_GiftBoxButton");
