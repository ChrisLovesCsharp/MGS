...
void UGiftingUserItem_C::SetSelectionState(ESelectionState NewState, bool bAnimateOnSelect)
{
	...
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GiftingUserItem.GiftingUserItem_C.SetSelectionState");
...
void UGiftingUserItem_C::UpdateMessageText(const struct FText& NewMessage)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GiftingUserItem.GiftingUserItem_C.UpdateMessageText");
...
void UGiftingUserItem_C::ExecuteUbergraph_GiftingUserItem(int EntryPoint)
{
	static UFunction* fn = NULL;
	if(!fn)
		fn = UObject::FindObject<UFunction>("Function GiftingUserItem.GiftingUserItem_C.ExecuteUbergraph_GiftingUserItem");
