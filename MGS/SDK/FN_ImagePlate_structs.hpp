...
struct FImagePlateParameters
{
	...
	struct FVector2D                                   FillScreenAmount;                                         // 0x0014(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   FixedSize;                                                // 0x001C(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FMovieSceneImagePlateSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	struct FMovieSceneImagePlateSectionParams          Params;                                                   // 0x0038(0x0018)
};
